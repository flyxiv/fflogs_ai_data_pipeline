...
class ReportExtractor():
	...
	def _find_all_reports_to_parse(self, ranking_urls: List[str]):
		...
		for ranking_url in ranking_urls:
			...
			self.reports_to_parse.append(self._parse_reports_to_read(driver.page_source))
	...
	def _parse_reports_to_read(self, ranking_url_body_text: str):
		...
		report_keys_already_collected = {json_file.stem for json_file in data_dir.rglob('*.json')}
...
if __name__ == "__main__":
	...
	NINJA_REPORT_EXTRACTOR = ReportExtractor(_EXTRACTOR_FILE_DIR / './ninja_ranking_urls.yml')
