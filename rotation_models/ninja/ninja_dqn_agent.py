...
class NinjaDQNAgent:
    ...
    def _build_delay_model(self):
        ...
        delay_output = keras.layers.Dense(1, activation='sigmoid')(dense2)
    ...
    def act1(self, state, is_gcd):
        return 0 if is_gcd else self.delay_model.predict(tf.reshape(state, (1, -1)), verbose=0)[0][0]
    ...
    def replay(self, batch_size):
        ...
        for state, action, reward, next_state, done, is_gcd in minibatch:
            ...
            if is_gcd:
                ...
                self.delay_model.fit(state_input, np.array(
